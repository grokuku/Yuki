...
2. Choisir un **WAV PCM** (≤ 30 s, ≤ 6 Mo), saisir un libellé, créer.
...
≤ 30 s, ≤ 6 Mo** (`src/tts/wav.ts`, `src/tts/voices-store.ts` ; limites
**révisées par D88**, `docs/lot9.md` §23). Or aucun WAV
...
| Profondeur | **16 bits** |
| Durée | **5,05 s** (≤ 30 s) |
| Taille | **445 536 octets** (≤ 6 000 000) |
